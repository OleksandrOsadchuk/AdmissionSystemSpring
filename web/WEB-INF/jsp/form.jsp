	...
	<div id="middle">
            ...
            <c:choose>
                ...
                <c:when test="${tab=='Result'}">
                   ...
                   <form action="${operationValue}" method="get">
                        <p><label><fmt:message key="Lstudentid"/></label><input type="number" name="sid" value="${idValue}"></p>
                        <p><label><fmt:message key="Lcourseid"/></label><input type="number" name="cid" value="${list[0].courseId}"></p>
